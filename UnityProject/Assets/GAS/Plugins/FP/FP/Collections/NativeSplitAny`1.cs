...
namespace Herta
{
    ...
    public readonly ref struct NativeSplitAny<T> where T : IEquatable<T>
    {
        /// <summary>
        ///     Buffer
        /// </summary>
        ...
        ///     Get enumerator
        /// </summary>
        public Enumerator GetEnumerator() => new Enumerator(_buffer, _separator);
        ...
        public ref struct Enumerator
        {
            ...
            {
                int index = _separator.Length == 1 ? _buffer.IndexOf(_separator[0]) : _buffer.IndexOfAny(_separator);
                if (index < 0)
                {
                    if (_buffer.Length > 0)
                    {
